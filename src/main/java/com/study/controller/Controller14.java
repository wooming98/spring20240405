...
public class Controller14 {
    ...
    public void method1(Model model) {
        MyBean141 o1 = new MyBean141("신촌", "한국", "흥민", 33);
    ...
    public void method2(Model model) {
        ...
        // attribute 명은 클래스명으로 결정
        // 좋은 습관은 이름을 직접 작성하는 것
        model.addAttribute(o1); // myBean142
        model.addAttribute(o2); // myBean142List
    }

    @RequestMapping("sub3")
    public void method3(@ModelAttribute("player1") MyBean142 o1) {
        o1.setName("오타니");
    }
    ...
    // 그 클래스를 사용해서
    // city, country, price 요청 파라미터 바인딩 받는 메소드 작성
    ...
    public void sub12(
        ...
        System.out.println("priva = " + price);
